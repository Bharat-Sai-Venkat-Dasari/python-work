...
Original file is located at
    https://colab.research.google.com/drive/1nsFmip4QXoF3mZLAnsGkWBZOhI2vyIFS
"""

import matplotlib.pyplot as plt

hours = [1, 2, 3, 4, 5, 6, 7, 8]
visitors = [10, 40, 50, 70, 40, 50, 40, 90]
plt.plot(hours, visitors, color='red', marker='o', linestyle='-',linewidth=1, alpha=1, label="Visitors")
...
plt.bar(products, sales, color='lightgreen', edgecolor='green', alpha=0.9, width=0.5)
